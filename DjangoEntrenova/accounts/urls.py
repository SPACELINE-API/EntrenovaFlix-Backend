...
from .views import (
    RegisterView, PostListCreateView, PostDetailView, ComentarioListCreateView, FuncionariosView, EmpresaRegistrationView, EmpresaListView, EmpresaDetailView, PrimeiroLoginView, GerarPDFView)
